...
public class TiDBPipelineTestBase {

private static final Logger LOG = LoggerFactory.getLogger(TiDBPipelineTestBase.class);
    ...
    protected void initializeTidbTable(String sqlFile) {
        ...
        final URL ddlTestFile = TiDBPipelineTestBase.class.getClassLoader().getResource(ddlFile);
