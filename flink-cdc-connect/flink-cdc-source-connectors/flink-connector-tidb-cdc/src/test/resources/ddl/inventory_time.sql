...
ALTER TABLE products_time AUTO_INCREMENT = 101;

INSERT INTO products_time(name,description,weight,pt_time)
VALUES ("scooter", "Small 2-wheel scooter", 3.14,"17:00:02"),
       ("car battery", "12V car battery", 8.1,"17:00:02"),
       ("12-pack drill bits", "12-pack of drill bits with sizes ranging from #40 to #3", 0.8,"17:00:02"),
       ("hammer", "12oz carpenter's hammer", 0.75,"17:00:02"),
       ("hammer", "14oz carpenter's hammer", 0.875,"17:00:02"),
       ("hammer", "16oz carpenter's hammer", 1.0,"17:00:02"),
       ("rocks", "box of assorted rocks", 5.3,"17:00:02"),
       ("jacket", "water resistent black wind breaker", 0.1,"17:00:02"),
       ("spare tire", "24 inch spare tire", 22.2,"17:00:02");
