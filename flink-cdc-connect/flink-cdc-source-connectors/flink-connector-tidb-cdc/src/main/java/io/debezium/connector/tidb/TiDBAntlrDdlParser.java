...
public class TiDBAntlrDdlParser extends AntlrDdlParser<MySqlLexer, MySqlParser> {
    ...
    public TiDBAntlrDdlParser(boolean throwErrorsFromTreeWalk, boolean includeViews, boolean includeComments,
                               TiDBValueConverters converters, Tables.TableFilter tableFilter) {
