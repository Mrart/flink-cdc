...
public class TiDBSourceFetchTaskContext extends JdbcSourceFetchTaskContext {
  ...
  public void configure(SourceSplitBase sourceSplitBase) {
    ...
    this.offsetContext =
        loadStartingOffsetState(new CDCEventOffsetContext.Loader(connectorConfig), sourceSplitBase);
    this.queue =
        new ChangeEventQueue.Builder<DataChangeEvent>()
            ...
            .loggingContextSupplier(
                () -> tidbTaskContext.configureLoggingContext("tidb-cdc-connector-task"))
