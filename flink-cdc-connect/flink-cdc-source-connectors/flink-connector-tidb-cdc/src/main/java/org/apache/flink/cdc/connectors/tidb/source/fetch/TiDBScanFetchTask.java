...
public class TiDBScanFetchTask extends AbstractScanFetchTask {
  ...
  protected void executeDataSnapshot(Context context) throws Exception {
    ...
    TiDBSnapshotSplitReadTask tiDBSnapshotSplitReadTask = new TiDBSnapshotSplitReadTask(
    ...
    SnapshotResult<CDCEventOffsetContext> snapshotResult = tiDBSnapshotSplitReadTask.execute(
  ...
  public static class TiDBSnapshotSplitReadTask
    ...
    @Override
    protected TiDBSnapshotContext prepare(
            TiDBPartition partition
    ) throws Exception {
