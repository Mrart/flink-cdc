...
public class TiDBUtils {
          ...
          rs -> {
            if (rs.next()) {
              ...
              return new CDCEventOffset(
                  String.valueOf(TSOToTimeStamp(binlogPosition)), String.valueOf(binlogPosition));
            } else {
  ...
  public static TiDBDatabaseSchema newSchema(
    ...
    TiDBDatabaseSchema schema =
        new TiDBDatabaseSchema(config, valueConverters, topicSelector, isTableIdCaseSensitive);
